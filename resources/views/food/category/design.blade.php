    ...
    <div class="col-sm-3 firstDiv">
      <div class="firstDiv1">
        <div class="row">
         <div class="col-md-12">
           <div class="well">
             <p style="color:#1015b5;font-weight:700;font-size:17px" id="1a">Business Unit</p>
           </div>
          </div>
       </div>
      </div>
      <div class="firstDiv2">
        <div class="row">
          <div class="col-sm-12" style="color:#1015b5;font-weight:700;font-size:15px">
            Invoice List
          </div>
        </div>
        <div class="row">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input class="button-width" type="text" id="itemCode" >
                  </div>
                </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                        <input class="button-width" type="text" id="quantity">
                      </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <input class="button-width" type="text" id="rate">
                  </div>
                </div>
               </div>
              <div class="col-sm-6">
  ...
  <div class="row p-2">
    <div class="col-sm-6">
      <div class="row  ">
        ...
        <div class="col-sm-6">
          <button type="button" class="btn btn-danger button-width button-height">Primary</button>
        </div>
      </div>    </div>
    <div class="col-sm-6">
      <div class="row  ">
        ...
        <div class="col-sm-6">
          <button type="button" class="btn btn-success button-width button-height ">Primary</button>
        </div>
      </div>    </div>
  </div>
