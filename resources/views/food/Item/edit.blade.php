...
@section('page-header')
    <i class="fa fa-pencil-square-o"></i> Edit Food
@stop
@section('css')
            ...
            <div class="widget-box">
                    ...
                    <span class="widget-toolbar">
                        @if (hasPermission("company.infos.view", $slugs))
                            <a href="{{ route('company.index') }}">
                                <i class="ace-icon fa fa-list-alt"></i> Food Update
                            </a>
                        @endif
                        </span>
                </div>
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        ...
                        <form class="form-horizontal" id="companyForm" action="{{ route('food.update',$food->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <h4 class="text-center">Food Update/h4>
                                    <hr>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 @error('foodname') has-error @enderror">
                                            <input type="text" class="form-control input-sm" name="foodname" required
                                                   value="{{$food->foodname}}" placeholder="Food Name">
                                        ...
                                        <div class="col-xs-12 col-sm-8 @error('name') has-error @enderror">
                                            <select name="category_id" class="chosen-select input-sm requeired" required data-placeholder="Choose a category...">
                                                ...
                                                @foreach($category as $categorys)
                                                    <option {{ $food->category_id == $categorys->id ? 'selected' : '' }} value="{{$categorys->id}}">{{$categorys->categoryname}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 ">
                                            <input type="number" class="form-control input-sm" id="fprice" name="price"
                                                   value="{{$food->price}}" placeholder="Food price">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input type="text" class="form-control input-sm" name="vat"
                                                   value="{{$food->vat}}" placeholder="Food vat">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 ">
                                            <input type="number" class="form-control input-sm" id="fcode" name="code"
                                                   value="{{$food->foodcode}}" placeholder="Food price">
